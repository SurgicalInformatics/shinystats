...
fluidPage(theme = shinytheme("cosmo"),
          ...
          fluidRow(
            column(6,
                   ...
                   h4(strong("Source code available in:")),
                   a(href="https://github.com/SurgicalInformatics/shinystats", "GitHub/SurgicalInformatics"),
          ...
          fluidRow(column(12,
                          h4("Privacy notice: ShinyStats.org does not collect any information on its users and it does not use cookies."))
          ),
          fluidRow(column(12,
                          includeMarkdown("www/shinystats_accessibility_statement.md"))
          )
          ))
)
